...
public class WifiLib {
     ...
     *                 </ul>
     * @param ssid     网络标识符
     * @param password 热点密码 ，密码可以为8-63个ASCII码或8-64个十六进制的字符
     ...
     * 连接到指定热点
     *
     * @param accessPoint 热点信息
     * @param password    密码,热点安全类型为WPA_PSK或者WPA2_PSK,密码必填
     * @return
     */
     ...
     * 方法中进行回调
     *
     * @param periodMillis 扫描的周期时间，单位为毫秒
     */
