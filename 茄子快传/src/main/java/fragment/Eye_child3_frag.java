 ...
 */
public class Eye_child3_frag extends Fragment implements LoadListView.IloadInterface, SwipeRefreshLayout.OnRefreshListener {
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                if (myAdaptre == null) {
                    loadlistview = (LoadListView) view.findViewById(R.id.loadlistview3);
                    loadlistview.setInterface(Eye_child3_frag.this);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.eye_child3_frag, container, false);
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.swip3);
        swipeRefreshLayout.setOnRefreshListener(Eye_child3_frag.this);
    ...
    public void onLoad() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                pager++;
                Object getnews = Juhedate.QiWenNews(pager + "");
    ...
    public void onRefresh() {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                Object getnews = Juhedate.QiWenNews(1 + "");
                if (myAdaptre != null) {
                    list.clear();
                }
                try {
